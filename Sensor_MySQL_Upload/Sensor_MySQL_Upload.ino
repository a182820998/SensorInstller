...
void loop()
{
    ...
    float sensor4Value = smoke(sensor4Pin);
    SentOnCloud(String(sensor1Value, 2), String(sensor2Value, 2), String(sensor3Value, 2), String(sensor4Value, 2));
    delay(10000);
}

void SentOnCloud(String value1, String value2, String value3, String value4)
{
